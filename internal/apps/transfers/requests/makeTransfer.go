...
type MakeTransferRequest struct {
	...
	FromCurrency  string `json:"from_currency" validate:"required,oneof=USD EUR GBP NGN"`
	ToCurrency    string `json:"to_currency" validate:"required,oneof=USD EUR GBP NGN"`
}
